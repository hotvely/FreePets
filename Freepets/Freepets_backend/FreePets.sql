...
ALTER TABLE MEDIA_LIKE ADD CONSTRAINT M_LIKE_CODE_PK PRIMARY KEY(M_LIKE_CODE);
...
ALTER TABLE COMMON_LIKE ADD CONSTRAINT C_LIKE_CODE_PK PRIMARY KEY(C_LIKE_CODE);
