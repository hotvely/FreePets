...
(
    ...
    DELETE_ACCOUNT_YN CHAR DEFAULT 'N' CHECK(DELETE_ACCOUNT_YN IN ('Y','N','y','n')) NOT NULL,
...
CREATE TABLE MEDIA(
 ...
 MEDIA_ADDFILEURL VARCHAR2(300) NOT NULL,
...
CREATE TABLE COMMON(
 ...
 COMMON_ADDFILEURL VARCHAR2(1000),
...
ALTER TABLE PRODUCT_REVIEW ADD CONSTRAINT PRODUCT_REVIEW_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;
...
ALTER TABLE PR_COMMENT ADD CONSTRAINT PR_COMMENT_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;

ALTER TABLE VIDEO_INFO ADD CONSTRAINT VIDEO_INFO_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;

ALTER TABLE VI_COMMENT ADD CONSTRAINT VI_COMMENT_VIDEO_INFO_CODE_FK FOREIGN KEY(VIDEO_INFO_CODE) REFERENCES VIDEO_INFO;
ALTER TABLE VI_COMMENT ADD CONSTRAINT VI_COMMENT_VIDEO_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;

ALTER TABLE HOSPITAL_REVIEW ADD CONSTRAINT HOSPITAL_REVIEW_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;
...
ALTER TABLE HR_COMMENT ADD CONSTRAINT HR_COMMENT_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER;
